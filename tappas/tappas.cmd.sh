...
# DIU
Rscript ${TAPPAS_DIR}/DIU.R -d trans -m DEXSEQ -f 2.0 -t FOLD ${OUTDIR}/Data ${OUTDIR}/DIU
Rscript ${TAPPAS_DIR}/DIU_ScatterPlot.R -d trans ${OUTDIR}/DIU/trans_diu_matrix.tsv ${OUTDIR}/DIU/trans_scatter_plot.png
Rscript ${TAPPAS_DIR}/DIU.R -d protein -m DEXSEQ -f 2.0 -t FOLD ${OUTDIR}/Data ${OUTDIR}/DIU
...
# DPA
Rscript ${TAPPAS_DIR}/DPA.R -m DEXSEQ -f 2.0 -t FOLD -l 60 ${OUTDIR}/InputData/design.tsv ${OUTDIR}/Data ${OUTDIR}/DPA
Rscript ${TAPPAS_DIR}/DPA_Heatmap.R -s 0.05 ${OUTDIR}/DPA ${OUTDIR}/DPA/heatmap_plot.png

# UTRL
Rscript ${TAPPAS_DIR}/UTRL.R -m WILCOXON -f 2.0 -t FOLD -l 100 ${OUTDIR}/InputData/design.tsv ${OUTDIR}/Data ${OUTDIR}/UTRL
